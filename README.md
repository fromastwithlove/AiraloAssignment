...
This project uses the publicly accessible backend API provided by [Airalo](https://www.airalo.com/), which is used here strictly for demonstration purposes as part of a technical assignment.
